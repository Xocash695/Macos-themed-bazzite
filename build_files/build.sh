...
# ==============================================================================
python3 -m venv /opt/konsave-venv
/opt/konsave-venv/bin/pip install konsave
/opt/konsave-venv/bin/konsave -i /ctx/macOS-layout.knsv
/opt/konsave-venv/bin/konsave -a macOS-layout -o /etc/skel
